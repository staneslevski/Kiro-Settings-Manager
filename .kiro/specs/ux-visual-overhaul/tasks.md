...
- [x] 1. Core color system (`color.py`)
  ...
  - [ ] 1.1 Terminal detection and semantic color foundations
    ...
    - [ ] 1.1.1 Write tests for `_color_level()` detection logic
    ...
    - [ ] 1.1.2 Implement `_color_level()` function
      - Priority: NO_COLOR → TERM=dumb → non-TTY → COLORTERM → TERM 256color → default 2
      - _Requirements: 2.1, 2.2, 2.3, 2.4, 2.5, 2.6, 2.7_

    - [ ] 1.1.3 Write tests for `_supports_unicode()` and symbol constants
    ...
    - [ ] 1.1.4 Implement `_supports_unicode()` and symbol constants
    ...
    - [ ]* 1.1.5 Write property test for `_color_level()` (Property 5)
      - **Property 5: _color_level() returns valid level respecting environment priority**
      - **Validates: Requirements 2.1, 2.2, 2.3, 2.4, 2.5, 2.6, 2.7**

  - [ ] 1.2 Semantic colors, style(), and text utilities

    - [ ] 1.2.1 Write tests for semantic color functions and `style()`
    ...
    - [ ] 1.2.2 Implement semantic color functions and `style()`
    ...
    - [ ] 1.2.3 Write tests for `_strip_ansi()` and `_align_columns()`
    ...
    - [ ] 1.2.4 Implement `_strip_ansi()` and `_align_columns()`
      - Regex `r'\033\[[0-9;]*m'` for strip
      - Calculate widths via stripped lengths, pad all but last column
      - _Requirements: 1.5, 4.1, 4.2, 4.3, 4.4_

    - [ ]* 1.2.5 Write property tests for color functions (Properties 1-4)
    ...
    - [ ]* 1.2.6 Write property test for `_align_columns()` (Property 6)
...
- [x] 2. Error formatting (`errors.py`)
  ...
  - [ ] 2.1 Error message formatting updates
    ...
    - [ ] 2.1.1 Write tests for updated format_error, format_warning, format_deprecation
    ...
    - [ ] 2.1.2 Update format_error, format_warning, format_deprecation
    ...
    - [ ]* 2.1.3 Write property tests for error formatting (Properties 7-8)
...
- [x] 3. Diff summary formatting (`copier.py`)
  ...
  - [ ] 3.1 Diff summary updates
    ...
    - [ ] 3.1.1 Write tests for updated format_diff_summary
    ...
    - [ ] 3.1.2 Update format_diff_summary with semantic colors and relative paths
    ...
    - [ ]* 3.1.3 Write property tests for diff summary (Properties 9-10)
...
- [x] 4. Command output formatting
  ...
  - [ ] 4.1 `ksm ls` output formatting
    ...
    - [ ] 4.1.1 Write tests for updated `_format_grouped()`
    ...
    - [ ] 4.1.2 Update `_format_grouped()` and `run_ls()` with semantic colors
      - Use accent for names, muted for registry/time, bold headers
      - Remove parentheses from registry names, add _align_columns()
      - _Requirements: 6.1-6.7, 16.1_

    - [ ]* 4.1.3 Write property tests for ls output (Properties 11-13)
  ...
  - [ ] 4.2 `ksm add` output formatting
    ...
    - [ ] 4.2.1 Write tests for add success output format
